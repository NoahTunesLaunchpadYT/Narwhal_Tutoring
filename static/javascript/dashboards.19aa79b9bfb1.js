document.addEventListener('DOMContentLoaded', function() {
    ...
    if (clientCalendarEl) {
        ...
        foundCalendars.push(clientCalendar);
    }
    ...
    if (tutorCalendarEl) {
        ...
        foundCalendars.push(tutorCalendar);
    }
    ...
    if (availabilityCalendarEl) {
        ...
        foundCalendars.push(availabilityCalendar);
    }

    
    setTimeout(function() {
        for(var i=0; i<foundCalendars.length; i++){
            foundCalendars[i].render()
        }
    });
